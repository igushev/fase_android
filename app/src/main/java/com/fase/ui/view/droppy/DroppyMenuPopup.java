...
import com.fase.ui.view.droppy.animations.DroppyAnimation;
import com.fase.ui.view.droppy.views.DroppyButtonClickDelegateInterface;
import com.fase.ui.view.droppy.views.DroppyMenuContainerView;
...
public class DroppyMenuPopup {
    ...
    protected DroppyButtonClickDelegateInterface droppyButtonClickDelegateInterface;
    ...
    protected boolean isBackgroundVisible = true;
    private boolean onAnchor = false;
    ...
    protected DroppyMenuPopup(
            ...
            DroppyButtonClickDelegateInterface droppyButtonClickDelegateInterface,
        ...
        this.droppyButtonClickDelegateInterface = droppyButtonClickDelegateInterface;
        ...
        if (addTriggerOnAnchorClick) {
            anchor.setOnClickListener(v -> {
                show();
                if (droppyButtonClickDelegateInterface != null) {
                    droppyButtonClickDelegateInterface.call(v);
                }
    ...
    public List<DroppyMenuItemInterface> getMenuItems() {
        return menuItems;
    }
    ...
    protected void addModal() {
        ...
        if (dimBackground) {
            modalWindow.setBackgroundResource(android.R.color.black);
            modalWindow.setAlpha(0.5F);
        }

        modalWindow.setOnClickListener(v -> dismiss(false));
    ...
    protected void detachPopupView() {
        if (mPopupView.getParent() != null) {
            try {
                ...
                Timber.e(e, "Error detaching popup");
            }
        }
    }
    ...
    public void setOnAnchor(boolean onAnchor) {
    ...
    protected void adjustDropDownPosition(FrameLayout.LayoutParams params, int xOffset, int yOffset) {
        ...
        if (onAnchor) {
            params.leftMargin = anchorPosition.x - 8;
            params.topMargin = anchorPosition.y - 3;
    ...
    public static class Builder {
        ...
        protected DroppyButtonClickDelegateInterface buttonDelegateInterface;
        ...
        protected boolean dimBackground = false;
        ...
        public Builder setOnButtonClick(DroppyButtonClickDelegateInterface droppyButtonClickDelegateInterface) {
            buttonDelegateInterface = droppyButtonClickDelegateInterface;
            return this;
        }
        ...
        public Builder setOnAnchorView(boolean onAnchor) {
            this.onAnchor = onAnchor;
            return this;
        }

        public Builder setDimBackground(boolean dimBacground) {
            this.dimBackground = dimBacground;
            return this;
        }
        ...
        public Builder isBackgroundVisible(boolean isBackgroundVisible) {
            this.isBackgroundVisible = isBackgroundVisible;
            return this;
        }
        ...
        public DroppyMenuPopup build() {
            DroppyMenuPopup popup = new DroppyMenuPopup(ctx, parentMenuItem, menuItems, callbackInterface, buttonDelegateInterface, triggerOnAnchorClick, -1, onDismissCallback);
            popup.setOffsetX(offsetX);
            popup.setOffsetY(offsetY);
            popup.setPopupAnimation(droppyAnimation);
            popup.setIsBackgroundVisible(isBackgroundVisible);
            popup.setOnAnchor(onAnchor);
            popup.setDimBackground(dimBackground);
